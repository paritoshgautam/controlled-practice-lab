...
function makeTest(n) {
  ...
  return {
    ...
    questions: [
      ...
      choice(`t${n}-ampere`, `Which statement is the physical definition of one ampere?`, ["One coulomb of charge passing a point each second.", "One joule of energy per coulomb.", "One volt per ohm-second.", "One watt of power in each resistor."], 0, "Current is rate of charge flow: 1 A = 1 C/s."),
